...
namespace GreenLeaf.Classes
{
    ...
    public static class JournalMethods
    {
        ...
        {
            return String.Format("{0} {1} {2} {3} ", ConnectSetting.User.Person.Surname, ConnectSetting.User.Person.Name, ConnectSetting.User.Person.Patronymic, (ConnectSetting.User.Person.Sex) ? verb : verb + "а");
        }
    }
}
