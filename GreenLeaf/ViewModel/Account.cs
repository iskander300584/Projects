                        ...
                        using (MySqlCommand command = new MySqlCommand(sql, connection))
                        {
                            using (MySqlDataReader reader = command.ExecuteReader())
                            {
                                while (reader.Read())
                                {
                                    ...
                                    PersonalData.Name = reader["NAME"].ToString();
                                    ...
                                    ReportsData.ReportUnIssuePurchaseInvoice = Conversion.ToBool(reader["REPORT_UN_ISSUE_PURCHASE_INVOICE"].ToString());
                                    ReportsData.ReportSalesInvoice = Conversion.ToBool(reader["REPORT_SALES_INVOICE"].ToString());
                                    ReportsData.ReportUnIssueSalesInvoice = Conversion.ToBool(reader["REPORT_UN_ISSUE_SALES_INVOICE"].ToString());
